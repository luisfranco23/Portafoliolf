    ...
    <section className='projetcs'>
      ...
      <div className="targets">
        <div className='target'>
          <h2 className='target__subtitle'><span className='number'>1.</span> E-commerce</h2>
          ...
          <div className="icons">
            ...
            <a className='icons__link' href="https://e-commercev1.netlify.app/" target='_blank'><i className='bx bx-link' ></i></a>
          </div>
        </div>
        <div className='target'>
          <h2 className='target__subtitle'><span className='number'>2.</span> Pokedex</h2>
        ...
        <div className='target'>
          <h2 className='target__subtitle'><span className='number'>3.</span> Usuarios App</h2>
          <p className='target__description'>Aquí puedes leer, crear, editar y eliminar usuarios (CRUD), cosume una API con axios uso de React Js manejando todas las peticiones http y excelente estilizado con css, perfecto para un sistema que requiera el control de usuarios y roles.</p>
        ...
        <div className='target'>
          <h2 className='target__subtitle'><span className='number'>4.</span> Rick And Morty</h2>
          <p className='target__description'>Puedes ver todos los planetas y sus habitantes, mostrando información detallada del mismo; consume una API, realizado con React Js y sus librerias, uso de JavaScript para filtros por ubicación, se encuentra en proceso de mejora y nuevas funcionalidades.</p>
        ...
        <div className='target'>
          <h2 className='target__subtitle'> <span className='number'>5.</span> Clima</h2>
